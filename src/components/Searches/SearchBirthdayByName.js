...
class BirthdaySearchByName extends Component {
  constructor(props) {
    super(props);
    this.searchArray = [];
    this.searchName = "";
  ...
  searchBirthdayByName = event => {
    event.preventDefault();
    this.isLoading = true;
    fetch(this.props.apiURL + "birthday/name/" + this.searchName)
      .then(res => res.json())
      .then(res => {
        console.log("Got it!");
        ...
        <div className="holiday-search-name">
          <form className="form-inline">
            ...
            <button
              ...
              type="submit"
              onClick={this.searchBirthdayByName}
            >
              Search
            </button>
          </form>
...
export default BirthdaySearchByName;
